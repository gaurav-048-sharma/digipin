...
//   useEffect(() => {
//     if (position) {
//       map.setView(position, 10); // Zoom to the decoded location
//     }
//   }, [position, map]);
//   return null;
// }
...
//   return (
//     <div className="container mx-auto p-6 bg-gradient-to-b from-blue-50 to-gray-100 min-h-screen">
//       <h1 className="text-4xl font-bold text-blue-800 mb-6 text-center">DigiPin Map Explorer</h1>
...
//       <h1 className="flex justify-center text-center text-3xl font-bold mb-5 p-5">DigiPin Map Application</h1>
...
//         <Card>
//           <CardHeader>
//             <CardTitle>DigiPin Encoder/Decoder</CardTitle>
//           </CardHeader>
//           <CardContent>
//             <div className="space-y-4">
//               <div>
//                 <h3 className="text-lg font-semibold">Encode Coordinates</h3>
//                 <div className="flex items-center gap-2">
//                   <Button className={"bg-amber-500 cursor-pointer"} onClick={handleEncode} disabled={!position}>
//                     Encode to DigiPin
//                   </Button>
//                   <label className="flex items-center bg-amber-200 p-2 rounded">
//                     <input
//                       type="checkbox"
//                       checked={includeHyphens}
//                       onChange={(e) => setIncludeHyphens(e.target.checked)}
...
//                 </div>
//                 {digiPin && (
//                   <p className="mt-2">DigiPin: <span className="font-mono">{digiPin}</span></p>
//                 )}
//               </div>
//               <div>
//                 <h3 className="text-lg font-semibold">Decode DigiPin</h3>
...
//                     onChange={(e) => setDigiPin(e.target.value)}
//                   />
//                   <Button className={"bg-amber-500 cursor-pointer"}  onClick={handleDecode}>Decode</Button>
//                 </div>
//                 {decodedCoords && (
//                   <p className="mt-2 bg-gray-300 p-2 rounded">
//                     Decoded: Lat {decodedCoords.latitude}, Lng {decodedCoords.longitude}
//                     {decodedCoords.fromDatabase && ' (from database)'}
//                   </p>
//                 )}
//               </div>
//             </div>
